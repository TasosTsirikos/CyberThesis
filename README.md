...
It includes features like logging in, submitting thesis topics, assigning committees, and tracking progress. The system is built using HTML, CSS, JavaScript, Node.js, express js, MySQL and more, to be easy to use, reliable, and able to handle large amounts of data.
